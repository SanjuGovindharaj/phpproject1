...
$dbres = mysql_query("SELECT * FROM  todo ORDER BY $dbOrder ASC");
...
$dbres = mysql_query("SELECT * FROM todo WHERE id=$dbId");
...
mysql_query("INSERT INTO todo(name, status) VALUES ($dbName, $dbStatus)");
return mysql_insert_id();
}

public function delete($id) {
$dbId = mysql_real_escape_string($id);
mysql_query("DELETE FROM todo WHERE id=$dbId");
}
